...
public class MancalaModel {
    ...
    /**
     * This method counts the number of times the player uses the undo function
     */
    ...
    /**
     * This method adds a hole to the MancalaBoard
     * @param pitComponent 		JComponent that holds the stones
     */
    ...
    /**
     * Method that updates the status of the mancala board
     */
  ...
  private void cleanUpSide(int startPit)
  {
   ...
   private void checkDropInEmpty(int current)
   {
    ...
    /**
     * Method that allows a player to undo a move
     * @param playerMove	
     */
   ...
   /**
    * This method initializes the number of stones for the start of the game
    */
