...
/**This a Jframe window which can be seen that contains multiple Jpanels on it,
 *
...
{
    private MancalaBoradContext newContext; // a reference pointing to Context class which use to strategy.
     ...
     * @return mancaB a type of JPanel
     */
